      ...
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-2">
          ...
          {isManager && notes.length > 0 && (
            <span className="text-xs text-[#50676E]">{notes.length}</span>
          )}
        </div>
        {isManager && (
          <button
                ...
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <span className="text-xs text-[#50676E] ml-2">
                      ...
                      <button
                        ...
                        className={`flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium transition-colors ${
                          note.is_visible_to_staff
                            ...
                            : "bg-[#F8F6F4] text-[#50676E] hover:bg-[#ECE3DF]"
                        }`}
                      >
                ...
                {note.is_visible_to_staff && (
                  <div className="pt-2 border-t border-[#ECE3DF]">
                    {note.acknowledged_at ? (
                      ...
                      <span className="text-xs text-[#50676E]">Awaiting acknowledgement</span>
                    )}
                  </div>
                )}
              </div>
