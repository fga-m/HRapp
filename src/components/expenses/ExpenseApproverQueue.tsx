...
import { Paperclip, AlertTriangle, Loader2, CheckCircle2 } from "lucide-react";
              ...
              <div className="flex gap-2 pt-1">
                ...
                {!failed && (
                  <button disabled={busy} onClick={() => { setRejectingId(claim.id); setNote(""); }}
                    className="px-4 py-2 border border-[#ECE3DF] text-[#5F7C84] rounded-lg text-xs font-semibold hover:bg-[#F8F6F4] transition-colors disabled:opacity-50">
                    Decline
                  </button>
                )}
              </div>
