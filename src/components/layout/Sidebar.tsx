...
export default function Sidebar({ isAdmin, userName, userEmail }: SidebarProps) {
  ...
  return (
    <aside className="w-64 min-h-screen bg-[#223149] flex flex-col">
      ...
      <div className="px-3 py-4 border-t border-white/10 space-y-1">
        <button className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-[#9BADB7] hover:bg-white/5 hover:text-white transition-colors w-full">
